  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>Welcome to your Messages panel.</Text>
      </View>

      <View style={styles.contentCard}>
        <View style={{flexDirection: 'row', alignItems: 'center', marginBottom: 15}}>
            <MaterialIcons name="forum" size={24} color="#2563eb" />
            <Text style={styles.sectionTitle}>Recent Data</Text>
        </View>
        <Text style={styles.dummyText}>
          Here you will find your Messages information. This section is currently showing demo content.
        </Text>
        {[1, 2, 3].map(i => (
