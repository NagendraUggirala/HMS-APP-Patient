  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>Welcome to your Billing & Payments panel.</Text>
      </View>
      ...
      <View style={styles.contentCard}>
        ...
        <Text style={styles.dummyText}>
          Here you will find your Billing & Payments information. This section is currently showing demo content.
        </Text>
        {[1, 2, 3].map(i => (
