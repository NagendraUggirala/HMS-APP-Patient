  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>Welcome to your Test Results panel.</Text>
      </View>

      <View style={styles.contentCard}>
        <View style={{flexDirection: 'row', alignItems: 'center', marginBottom: 15}}>
            <MaterialIcons name="biotech" size={24} color="#2563eb" />
            <Text style={styles.sectionTitle}>Recent Data</Text>
        </View>
        <Text style={styles.dummyText}>
          Here you will find your Test Results information. This section is currently showing demo content.
        </Text>
        {[1, 2, 3].map(i => (
