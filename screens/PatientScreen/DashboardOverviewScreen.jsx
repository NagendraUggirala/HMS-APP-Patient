  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>Welcome to your dashboard overview panel.</Text>
      </View>
      ...
      <View style={styles.contentCard}>
        ...
        <Text style={styles.dummyText}>
          Here you will find your dashboard overview information. This section is currently showing demo content.
        </Text>
        {[1, 2, 3].map(i => (
          <View key={i} style={styles.item}>
            <Text style={styles.itemTitle}>Sample Record #00{i}</Text>
